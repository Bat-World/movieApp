...
export const ImageShiftPart = () => {
  return (
    <div className="w-screen h-auto  flex  flex-col lg:relative">
        <div className="ImageContainer w-100% h-[246px] flex justify-center items-center lg: h-[600px]">
          here goes image
        </div>
        <div className="AboutMovie w-100% h-auto px-[20px] py-[20px] flex flex-col gap-[16px] justify-content lg:absolute  lg:top-40% lg:left-10% lg:w-[302px] lg:h-[246px] lg:rounded-[8px] lg:bg-transparent">
